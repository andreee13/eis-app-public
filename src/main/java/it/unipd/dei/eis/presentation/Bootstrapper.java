...
public class Bootstrapper {
    ...
    public void launch() {
        ...
        options.addOption(Option.builder().option("ct").longOpt("count-terms").desc("Number of terms").hasArg().argName("integer").type(Number.class).build());
        options.addOption(Option.builder().option("ca").longOpt("count-articles").desc("Number of articles").hasArg().argName("integer").type(Number.class).build());
