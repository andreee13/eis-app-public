...
| Download&Estrazione  | Invoca sequenzialmente Download ed Extract, producendo i rispettivi output (_file JSON_ e _file txt_) The Guardian API     | Sorgente dalla quale vengono scaricati i dati, che saranno poi convertiti in articoli, alla quale si accede tramite una API Key                                                                                                                                                                                                                                                                                                         |
