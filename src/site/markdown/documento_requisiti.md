...
| Caso d'uso         | Sceglie operazione                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Attori             | Utente, Download / Estrazione / Download&Estrazione                                                                                                                                                                                                                                |
| Opzioni supportate | L'utente può decidere che funzionalità far eseguire al programma scegliendo tra: scaricare articoli, estrarre i termini più frequenti e visualizzare i risultati o effettuare entrambe le operazioni in sequenza                                                                                                                                                                                                                                                                                                         |
| Stimolo            | Al momento dell'esecuzione l'utente deve specificare una determinata sorgente: The Guardian API [theguardian], Input file JSON [path/to/file.json] o Input file CSV [path/to/file.csv]; e, opzionalmente, una determinata opzione:  numero di articoli [-ca]; numero di parole da estrarre [-ct]; eseguire solo il download [-d]; eseguire solo l'estrazione [-e]; filtri temporali [-f] e [-t]; estrarre lemmi o solo parole senza punteggiatura [-l]; nome file di output articoli [-oa]; nome del file di output termini [-ot]; filtri di ricerca [-q];                                                                            |
| Risposta           | In base al comando ricevuto il programma procede al download degli articoli [-d], scaricandoli da testate giornalistiche tramite le fonti supportate e salvandoli in un formato comune; all'estrazione dei termini più ricorrenti [-e] in un file di testo da un articolo modellizzato, precedentemente scaricato; o al download e all'estrazione in sequenza, generando i rispettivi output |
