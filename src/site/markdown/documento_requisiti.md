...
The New York Times CSV
File provenienti da un download precedente|
|Output|_file JSON_ contenente la lista degli articoli, quando è eseguito il download
_file txt_ contenente i termini più ricorrenti, quando è eseguita l'estrazione
entrambi, quando sono eseguiti download ed estrazione in sequenza|
|Azione||
|Richiede||
